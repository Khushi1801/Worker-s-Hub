...
try{
  ...
  ResultSet rs=st.executeQuery("SELECT * FROM orders JOIN packages ON orders.package_id = packages.id and orders.status='cancel' JOIN users ON orders.cust_email = users.email order by orders.order_date DESC");
  while(rs.next()){
%>
