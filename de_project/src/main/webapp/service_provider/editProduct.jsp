...
<input class="input-style" type="text" name="discription" value="<%= rs.getString(4) %>" required> 
<hr>
</div>

<div class="left-div">
<h3>Enter Price</h3>
<input class="input-style" type="number" name="price" value="<%= Integer.parseInt(rs.getString(5)) %>" required>
<hr>
</div>
